...
export function Projects() {
  const projects = [
    ...
    },
    {
      ...
      description: 'A mobile-responsive task management application with real-time updates and collaborative features.',
    ...
    },
    {
      ...
      description: 'Machine learning model for image classification using deep learning techniques with a web interface.',
